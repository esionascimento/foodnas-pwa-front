...
const HeaderComponent = () => {
  return (
    <>
      <header className="fixed z-50 w-screen bg-slate-300 p-6 px-15">
        <div className="hidden md:flex w-full h-full items-center justify-between">
          <div className="flex items-center gap-2">
            <p className="text-headingColor text-xl font-bold">FoodNas</p>
          </div>
          <div className="flex items-center gap-8">
            ...
            <MdAccountCircle className="w-10 min-w-[40px] h-10 min-h-[40px] drop-sha"/>
          </div>
        </div>
        {/* MOBILE */}
