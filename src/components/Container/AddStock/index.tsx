...
import { inputTwoPart, inputThreePart } from "src/config/add-stock";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-y divide-black">
          <div className="py-2 flex items-start  justify-between">
            <div className="">
              ...
              <div className="flex">
                <input
                  type="number"
                  id="barcode"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[40%] p-1 mr-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder=""
                  required
                />
                <button
            ...
            <div className="w-[50%] align-end">
              ...
              <button
                type="button"
                className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm p-1.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Ler
              </button>
            </div>
